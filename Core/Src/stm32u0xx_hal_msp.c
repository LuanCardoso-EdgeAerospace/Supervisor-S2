...
void HAL_I2C_MspInit(I2C_HandleTypeDef* hi2c)
{
  ...
  */
    ...
    PA7     ------> I2C3_SCL
    */
    GPIO_InitStruct.Pin = SNS_I2C_SDA_Pin|SNS_I2C_SCL_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_OD;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
...
void HAL_I2C_MspDeInit(I2C_HandleTypeDef* hi2c)
{
  ...
  else if(hi2c->Instance==I2C2)
  {
    ...
    PB14     ------> I2C2_SDA
    */
    HAL_GPIO_DeInit(TEMP_I2C_SCL_GPIO_Port, TEMP_I2C_SCL_Pin);

    HAL_GPIO_DeInit(TEMP_I2C_SDA_GPIO_Port, TEMP_I2C_SDA_Pin);
  ...
  else if(hi2c->Instance==I2C3)
  {
    ...
    PA7     ------> I2C3_SCL
    */
    HAL_GPIO_DeInit(SNS_I2C_SDA_GPIO_Port, SNS_I2C_SDA_Pin);

    HAL_GPIO_DeInit(SNS_I2C_SCL_GPIO_Port, SNS_I2C_SCL_Pin);
...
void HAL_UART_MspInit(UART_HandleTypeDef* huart)
{
  ...
  */
    ...
    PA3     ------> LPUART1_RX
    */
    GPIO_InitStruct.Pin = MCU_RS422_TX_Pin|MCU_RS422_RX_Pin;
  ...
  */
    ...
    PB11     ------> LPUART2_TX
    */
    GPIO_InitStruct.Pin = UART3_CPU_RX_Pin|UART3_CPU_TX_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
...
void HAL_UART_MspDeInit(UART_HandleTypeDef* huart)
{
  if(huart->Instance==LPUART1)
  {
    ...
    PA3     ------> LPUART1_RX
    */
    HAL_GPIO_DeInit(GPIOA, MCU_RS422_TX_Pin|MCU_RS422_RX_Pin);
  ...
  else if(huart->Instance==LPUART2)
  {
    ...
    PB11     ------> LPUART2_TX
    */
    HAL_GPIO_DeInit(GPIOB, UART3_CPU_RX_Pin|UART3_CPU_TX_Pin);
